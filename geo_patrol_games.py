...
def run_server_client_game(gs_host_addr, GP, case_num):
    ...
    while not cur_game_state[GS.GAME_DONE]:
        ...
        if plr_client.engagement_outcomes is not None:
            local_game.engagement_outcomes = GS.arbitrary_engagement_outcomes_from_server(GAME_PARAMS,plr_client.engagement_outcomes)[0]
            koth.print_engagement_outcomes(local_game.engagement_outcomes)
            penv.actions = GS.arbitrary_engagement_outcomes_from_server(GAME_PARAMS,plr_client.engagement_outcomes)[1]
