...
def human_v_ai():
    ...
    #model_path_beta = "./policies/model_offensive_6Apr6200.pt" #3800 iterations of board without outer ring. Trained on randagm init game params.
    model_path_beta = "./policies/model_O3_6500.pt"
...
def run_game(model_path_beta):
    ...
    while True:
        ...
        new_obs_tensor_beta = torch.tensor(obs[U.P1]['observation'], dtype=torch.float32)

        #Get Action masks
        new_obs_tensor_am_beta = torch.tensor(obs[U.P1]['action_mask'], dtype=torch.float32)
        ...
        actions_beta_dict = penv.decode_discrete_player_action(U.P1,acts_beta_tuple)
